...
public class Board extends JPanel implements ActionListener {
    ...
    Color dotcolor2=new Color(192,0,0);
    Color mazecolor;
    ...
    final int maxscaredtime=100;
    final int  minscaredtime=20;

    Image ghost,ghostscared;
    ...
    { 35, 26, 26, 26, 18, 18, 26, 26, 26, 18, 18, 26, 26, 26, 38,
      21, 0,  0,  0,  17, 28, 0, 0, 0, 25, 20, 0, 0, 0, 21,
      17, 22,  0,  19,  20, 0, 0, 0, 0, 0, 17, 22, 0, 19, 20, 
      17, 20,  0,  17,  16, 18, 18, 26, 18, 18, 16, 20, 0, 17, 20, 
      17, 16, 26, 24, 24, 16, 20, 0,  17, 16, 16, 16, 18, 16, 20,
      17, 20, 0, 0, 0, 17, 20, 0,  17, 16, 16, 16, 16, 16, 20, 
      9, 16, 18, 18, 26, 24, 28, 0,  25, 24, 24, 16, 16, 16,  12, 
      1,  17, 16, 20, 0,  0,  0,  0,  0,  0,  0,  17, 16, 20,  4,
      1,  17, 16, 16, 18, 18, 22, 0,  19, 18, 18, 16, 16, 16,  22,
      19,  16, 24, 24, 24, 16, 20, 0,  17, 16, 16, 16, 16, 16,  28,
      17,  20, 0, 0, 0, 17, 20, 0,  17, 16, 16, 16, 16, 20,  4,
      25,  16, 22, 0, 19, 16, 16, 18, 16, 16, 16, 24, 24, 16,  22,
      1,  17, 20, 0, 25, 24, 24, 24, 16, 16, 20, 0, 0, 17,  20,
      1,  17, 20, 0, 0, 0, 0, 0, 17, 16, 20, 0, 0, 17, 20,
      43,  24,  24,  26,  26,  26,  26,  26,  24,  24,  24, 26, 26, 24, 44 };
    
    final short leveldata2[] =
        { 35, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 38,
          17, 24,  24,  24,  24, 24, 16, 16, 16, 24, 24, 24, 24, 24, 20,   
          21, 0,  0,  0,  0, 0, 17, 16, 20, 0, 0, 0, 0, 0, 21, 
          21, 0, 19, 26, 18, 18, 16, 24,  16, 18, 18, 26, 22, 0, 21,
          21, 0, 21, 0, 25, 24, 20, 0,  17, 24, 28, 0, 21, 0, 21,
          21, 0, 21, 0, 0, 0, 21, 0,  21, 0, 0, 0, 21, 0,  21, 
          21,0, 21, 0, 19, 26,  28,  0,  25, 26, 22,  0, 21, 0,  21,
          21, 0, 17, 26, 20, 0, 0, 0,  0, 0, 17, 26, 20, 0,  21,
          21,0, 21, 0, 25, 26, 22, 0,  19, 26, 28, 0, 21, 0,  21,
          21, 0, 21, 0, 0, 0, 21, 0,  21, 0, 0, 0, 21, 0, 21,
          21,0, 21, 0, 19, 18, 20, 0, 17, 18, 22, 0, 21, 0,  21,
          21,0,25,26,24,24,16,18,16,24,24,26,28,0,21,
          21, 0,  0,  0,  0, 0, 17, 16, 20, 0, 0, 0, 0, 0, 21, 
          17,  18, 18, 18, 18, 18, 16, 16, 16, 18, 18, 18, 18, 18, 20,
    ...
    public void ShowIntroScreen(Graphics2D g2d) {
        ...
        g2d.setColor(new Color(130, 0, 30));
        g2d.fillRect(50, scrsize / 2 - 30, scrsize - 100, 50);
        g2d.setColor(Color.GRAY);
        g2d.drawRect(50, scrsize / 2 - 30, scrsize - 100, 50);

        String s = "Πατήστε το S για εκκίνηση";
        Font small = new Font("Times New Roman", Font.ITALIC, 14);
 ...
 ghostx[i] / blocksize + nrofblocks * (int)(ghosty[i] / blocksize);
    ...
    public void DrawGhost(Graphics2D g2d, int x, int y) {
       ...
       {g2d.drawImage(ghostscared, x, y, this);}
 ...
 pacmanx / blocksize + nrofblocks * (int)(pacmany / blocksize);
    ...
    public void GetImages()
    {
      ...
      ghostscared=new ImageIcon(Board.class.getResource("images/blueghost.png")).getImage();
